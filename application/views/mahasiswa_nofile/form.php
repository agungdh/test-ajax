  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <table class="table">
        ...
        <tr>
          <td>NPM</td>
          <td><input type="number" name="npm" placeholder="NPM" class="form-control"></td>
        </tr>
        <tr>
          <td>Nama</td>
        ...
        <tr>
          <td>Tanggal Lahir</td>
          <td><input type="text" name="tanggal_lahir" placeholder="Tanggal Lahir" class="form-control"></td>
        </tr>
        <tr>
          <td></td>
          <td>
